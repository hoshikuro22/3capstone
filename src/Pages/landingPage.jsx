        ...
        <div className="bg-white p-8 rounded shadow-lg w-80 my-10">
          ...
          <form>
            <div className="mb-4">
              ...
              <input required type="email" id="username" name="username" className="mt-1 px-3 py-2 w-full border rounded-md focus:ring focus:ring-blue-200" />
            </div>
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700">Password</label>
              <input required type="password" id="password" name="password" className="mt-1 px-3 py-2 w-full border rounded-md focus:ring focus:ring-blue-200" />
            </div>
